<template>
  <nav
    class="relative flex flex-wrap items-center justify-between px-2 py-3 bg-blue-900 mb-3"
  >
    <div
    ...
    >
      ...
      >
        <ul class="flex flex-col lg:flex-row list-none ml-auto">
          ...
          <li class="nav-item">
            <a
              class="px-3 py-2 flex items-center text-xs font-bold leading-snug text-black hover:opacity-75 bg-green-300 rounded-md"
              href="#pablo"
            >
              <i
